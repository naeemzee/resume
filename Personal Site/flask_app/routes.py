...
@app.route('/home')
def home():
    # Dummy data retrieval, replace with actual data
    print(db.query('SELECT * FROM users'))
    x = random.choice(['I started university when I was 18 years old.','I watch sports like the NFL and NHL.','I play video games.'])
